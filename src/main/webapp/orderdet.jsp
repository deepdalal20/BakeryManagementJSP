...
String ins = "INSERT INTO `tblorderdetail`(`u_id`, `od_name`, `od_email`, `od_address`, `od_city`, `od_state`, `od_pin`, `od_total`, `od_date`) VALUES ('"+ses+"', '"+name+"', '"+email+"', '"+add+"', '"+city+"', '"+state+"', '"+pin+"', '"+gt+"', '"+date+"')";
